...
int main() {
    ...
    char topics[5][10][50] = {
	    {"Probability Theory", "Distributions", "Central Limit Theorum", "Hypothesis Testing", "Data Handling", "Curve Fitting", "Density Estimation", "Principal Component Analysis", "Intro to R", "Intro to Python"},
    ...
    outputFp = fopen("ques3_sample_test_1_output.txt", "w");
